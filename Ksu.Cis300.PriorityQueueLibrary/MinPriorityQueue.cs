...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue <TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            if(x > 0)
            {
                LeftistTree<KeyValuePair<TPriority, TValue>> tree =new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h2.RightChild, h1));
                return tree;
            }
            else
            {
                LeftistTree<KeyValuePair<TPriority, TValue>> tree = new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data, h1.LeftChild, Merge(h1.RightChild, h2));
                return tree;
            }
        ...
        /// <summary>
        /// Removes minimum priority
        /// </summary>
        /// <returns>returns value without the removed priority</returns>
